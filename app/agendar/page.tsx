...
import { listarVeiculosComStatus } from '@/app/lib/veiculos'; // Removed unused 'listarVeiculos'
...
export default function AgendarPage() {
    ...
    useEffect(() => {
        const carregarVeiculos = async () => {
            ...
            try {
                ...
                setVeiculos(lista.filter((v) => v.status?.disponivel)); // Ensure 'status' is defined
            } catch (error) {
    ...
    const getMinDate = () => {
        if (typeof window === 'undefined') return ''; // Garantir que o código não quebre no SSR
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    min={getMinDate()} // Usar função para evitar inconsistências
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    min={dados.saida || getMinDate()} // Usar função para evitar inconsistências
                                    className="w-full p-2 border border-green-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm text-gray-900"
                                    required
                                />
                            </div>
